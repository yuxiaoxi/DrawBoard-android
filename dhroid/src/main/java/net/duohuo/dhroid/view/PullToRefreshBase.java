...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_model)) {
			mode = a.getInteger(R.styleable.PullToRefresh_model,
		...
		String pullToRefreshLabel = context
				.getString(R.string.pull_to_refresh_pull_label);
		String refreshingLabel = context
				.getString(R.string.pull_to_refresh_refreshing_label);
		String releaseToRefreshLabel = context
				.getString(R.string.pull_to_refresh_release_label);
		String pullToLoadLabel = context
				.getString(R.string.pull_to_loadmore_pull_label);
		String loadingLabel = context
				.getString(R.string.pull_to_loadmore_loading_label);
		String releaseToLoadLabel = context
				.getString(R.string.pull_to_loadmore_release_label);

		// Add Loading Views
		if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
			headerLayout = new LoadingLayout(context,
					MODE_PULL_DOWN_TO_REFRESH, releaseToRefreshLabel,
					pullToRefreshLabel, refreshingLabel);
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH,
					releaseToLoadLabel, pullToLoadLabel, loadingLabel);
